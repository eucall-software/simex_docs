...
photon experiments, that follows a linear base pattern: The radiation is produced
...
required for further interactions, such as laser-plasma based short wavelength-short pulse length sources,
proton radiography and proton cancer therapy using laser accelerated protons.

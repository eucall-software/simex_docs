...
measurements.
%, which served as an input to the simulation. to validate the
%calculation of diffraction patterns in \textit{simex\_platform}.
%
\begin{figure}[ht]
  \begin{center}
...
sample is composed of \SI{100}{\nano\meter} \ch{LaAlO3} (LAO) and
\SI{50}{\nano\meter} \ch{LaSrMnO_3} (LSMO).
...
\begin{figure}[ht]
    \begin{center}
      \includegraphics[width=0.8\textwidth,angle=0,clip]{diffraction_1d_esrf}
    \end{center}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[width=0.8\textwidth,angle=0,clip]{diffraction_1d_esrf_results}
    \end{center}
...
\begin{figure}
  ...
  \begin{subfigure}{0.45\textwidth} % width of left subfigure
	  ...
	  \caption{View of the login Page of the JupyterHub instance \url{https://max-jhub.desy.de} at DESY} % subcaption
  \end{subfigure}
...
\includepdf[pages=-, noautoscale=true, scale=0.9]{contributions/XFEL/demos/s2e_spi/start_to_end_demo.pdf}
%
\subsection{Nanocrystal diffraction}
\includepdf[pages=1-2, noautoscale=true, scale=0.9]{contributions/XFEL/demos/xstal/xstal_diffraction.pdf}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%

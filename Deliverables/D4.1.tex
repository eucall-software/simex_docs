...
undergoes a change in magnitude and direction \marginpar{correct?} with a
...
\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=1.0\textwidth,angle=0,clip]{bussmann_saxs_setup}
  \end{center}
...
for normal SAXS and Ab for resonant SAXS, respectively. \marginpar{Find suitable
targets}.
...
different types of plasma instabilities \cite{} \marginpar{Reference?}.

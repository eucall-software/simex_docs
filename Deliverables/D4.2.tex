...
\ihead{D4.2: Long Pulse Laser -- Matter Interaction} % left head
...
%\subsection{XAFS}
%The XAFS signal reflects the near order of the shock compressed matter. The
%absorption edge is modulated by the ion-ion correlation function $\chi(\vec q)$.
